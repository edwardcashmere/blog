defmodule OmondoBlogWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OmondoBlogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OmondoBlogWeb.Gettext, "errors", msg, opts)
    end
  end
